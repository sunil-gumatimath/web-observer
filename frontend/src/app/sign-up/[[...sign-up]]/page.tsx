  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center gap-8 overflow-hidden px-4 py-12">
      ...
      <div className="relative z-10 text-center">
        ...
        <h1 className="mt-4 text-2xl font-semibold text-slate-900 dark:text-white">Create your account</h1>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Start monitoring pages in a few minutes</p>
      </div>
