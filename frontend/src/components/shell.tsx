...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen text-slate-900 dark:text-slate-100" suppressHydrationWarning>
      <header
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 animate-fade-in-up" suppressHydrationWarning>
        {children}
      </main>
    </div>
  );
